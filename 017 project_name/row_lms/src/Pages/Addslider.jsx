          ...
          <div className=''>
            <div className='bg-white w-[100%] mb-[50px] p-4 h-full rounded-[20px]'>
              <form action="" onSubmit={handleAddSlides}>
                Slider Heading
                <input type="text" name='slidesheading' className='border border-gray-400 px-4 w-full h-[50px] mb-3 mt-2 ' />
                Slider Sub-Heading
                <input type="text" name='slidessubheading' className='border border-gray-400 w-full h-[50px] mb-3 mt-2 px-4 ' />
                Slider Image
